  ...
  const [jobs,setJobs] = useState([]);
    ...
    let headers = {
      ...
      async function fetchData(){
        ...
        axios
        .get("http://192.168.0.104:5500/Donate",headers)
...
<ScrollView>
    <View className="">
      <Image source = {{uri: "https://img.freepik.com/free-vector/tiny-people-standing-near-box-donation-food-delivery-volunteers-giving-healthy-grocery-goods-charity-flat-vector-illustration-social-support-humanitarian-help-community-sharing-concept_74855-21023.jpg"}} className="w-full  h-96 rounded-b-full"/>
    </View>

   <View className="pt-3">
    <Text className="font-bold text-center text-3xl">Donation Foods</Text>
   </View>
