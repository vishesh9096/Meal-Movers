  ...
  const [jobs,setJobs] = useState([]);
    ...
    let headers = {
      ...
      async function fetchData(){
        ...
        axios
        .get("http://192.168.0.104:5500/Cooked",headers)
...
<ScrollView>
    <View className="">
      <Image source = {{uri: "https://img.freepik.com/free-photo/top-view-table-full-delicious-food-composition_23-2149141353.jpg?w=2000"}} className="w-full  h-96 rounded-b-full"/>
    </View>

   <View className="pt-3">
    <Text className="font-bold text-center text-3xl">Cooked Meals</Text>
   </View>
