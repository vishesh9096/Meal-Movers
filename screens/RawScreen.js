  ...
  const [jobs,setJobs] = useState([]);
    ...
    let headers = {
      ...
      async function fetchData(){
        ...
        axios
        .get("http://192.168.0.104:5500/Raw",headers)
...
<ScrollView>
    <View className="">
      <Image source = {{uri: "https://images.theconversation.com/files/493473/original/file-20221104-21-pcdn7v.jpg?ixlib=rb-1.1.0&rect=0%2C0%2C4500%2C3206&q=45&auto=format&w=926&fit=clip"}} className="w-full  h-96 rounded-b-full"/>
    </View>

   <View className="pt-3">
    <Text className="font-bold text-center text-3xl">Raw Foods</Text>
   </View>
