...
const DropdownComponent = /*#__PURE__*/React.forwardRef((props, currentRef) => {
  ...
  const _renderList = useCallback(isTopPosition => {
    ...
    }, isTopPosition && _renderListHelper(), renderSearch(), !isTopPosition && _renderListHelper()));
  }, [_renderItem, accessibilityLabel, flatListProps, listData, renderSearch, scrollIndex, showsVerticalScrollIndicator, testID, valueField]);
  ...
  const _renderModal = useCallback(() => {
    ...
    return null;
  }, [visible, position, keyboardHeight, maxHeight, dropdownPosition, keyboardAvoiding, statusBarIsTranslucent, showOrClose, styleContainerVertical, backgroundColor, containerStyle, styleHorizontal, _renderList]);
